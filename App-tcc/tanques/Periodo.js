...
export default class Periodo extends Component {
   ...
   state = {  
      choosenIndex: 1  ,   choosenIndexgraf: 1
  };   
  render() {
    return (
      <View  >
        ...
        <View style = {styles.container}>   
           <Picker style={styles.pickerStyle}  
                        ...
                        onValueChange={(itemValue, itemPosition) =>  
                            this.setState({language: itemValue, choosenIndex: itemPosition+1})}  
                    >  
                   
                    <Picker.Item label="Histórico do dia" value="1" />  
                    <Picker.Item label="Histórico anterior" value="2" />  
            </Picker>  
            </View>     
